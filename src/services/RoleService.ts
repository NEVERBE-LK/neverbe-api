...
export const getAllPermissions = (): Permission[] => {
  return [
    ...
    { key: "view_purchase_orders", label: "View Purchase Orders", group: "Purchase Orders" },
    { key: "create_purchase_orders", label: "Create Purchase Orders", group: "Purchase Orders" },
    { key: "update_purchase_orders", label: "Update Purchase Orders", group: "Purchase Orders" },
    { key: "view_grn", label: "View Goods Received", group: "Goods Received" },
    { key: "create_grn", label: "Create GRN", group: "Goods Received" },
    { key: "approve_po", label: "Approve Purchase Orders", group: "Purchase Orders" },
    { key: "approve_grn", label: "Approve Goods Received Notes", group: "Goods Received" },
